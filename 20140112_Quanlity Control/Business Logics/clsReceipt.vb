...
#End Region
    ...
    Private Function InitializeApprisal(ByVal aDocEntry As Integer) As Boolean
        Try
            ...
            oGeneralService = oCompanyService.GetGeneralService("Z_OQFCL")
            ...
            oRec.DoQuery("Select * from OIGN where isnull(U_Z_QCDocNum,'')='' and DocEntry=" & aDocEntry)
            ...
            oChildren1 = oGeneralData1.Child("Z_QFCL1")
            oRec.DoQuery("Select * from IGN1 where DocEntry=" & aDocEntry)
            ...
            If blnline = True Then
                ...
                oRec.DoQuery("Update OIGN set U_Z_QCDocNum='" & strDocEntry & "' where DocEntry=" & aDocEntry)
        ...
        Try
            If BusinessObjectInfo.BeforeAction = False And BusinessObjectInfo.ActionSuccess = True And (BusinessObjectInfo.EventType = SAPbouiCOM.BoEventTypes.et_FORM_DATA_ADD Or BusinessObjectInfo.EventType = SAPbouiCOM.BoEventTypes.et_FORM_DATA_UPDATE) Then
                ...
                If oDoc.Browser.GetByKeys(BusinessObjectInfo.ObjectKey) Then
                    ...
                    InitializeApprisal(oDoc.DocEntry)
                End If
            End If
        Catch ex As Exception
            MsgBox(ex.Message)
